...
///
/// RISC-V 32-bit uses `add` and `sltu` (set-less-than unsigned) to detect arithmetic wrap-around.
...
pub unsafe fn add_limbs_3_unchecked(
    ...
    unsafe {
        asm!(
            ...
            "add {t2}, {t1}, {t0}",                      // t2 = src2[0] + src1[0]
            "sltu {c0}, {t2}, {t0}",                     // c0 = 1 if addition wrapped
            "add {t2}, {t2}, {carry}",                   // t2 += carry
            ...
            "add {t2}, {t1}, {t0}",                      // Add limbs
            "sltu {c0}, {t2}, {t0}",                     // Detect wrap
            "add {t2}, {t2}, {carry}",                   // Add carry
