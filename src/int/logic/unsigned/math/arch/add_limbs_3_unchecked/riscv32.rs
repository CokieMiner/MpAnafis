...
pub unsafe fn add_limbs_3_unchecked(
    ...
    unsafe {
        asm!(
            ...
            "1:",
            "lw {t0}, 0({src1})",          // t0 = src1[0]
            "lw {t1}, 0({src2})",          // t1 = src2[0]
            "add {t2}, {t1}, {t0}",        // t2 = src2 + src1 (may wrap)
            ...
            "addi {src1}, {src1}, 16",     // advance src1 by 16 bytes (4 × u32)
            "addi {src2}, {src2}, 16",     // advance src2 by 16 bytes
