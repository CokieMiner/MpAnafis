...
use super::MpInt;
use super::{BoundedPrecision, InternalMpUint, Limb, MpUint, Precision, Strategy, Vec, any};
#[cfg(feature = "std")]
...
pub fn uint(value: u64) -> MpUint {
    MpUint {
        value: InternalMpUint::from_u64(value),
        precision: Precision::Unlimited,
    }
}

#[cfg(feature = "num-traits")]
pub fn int_from_i64(value: i64) -> MpInt {
    MpInt::from(value)
}
