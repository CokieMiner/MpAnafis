...
//! to a temporary file, injected with `ARBI_TUNING_PROFILE`, and scored by the
...
const SSA_PREFIX: &str = "ARBI_SSA_SCORE=";
const SSA_COARSE_FLAG: &str = "--score-ssa-coarse";
const SSA_COARSE_PREFIX: &str = "ARBI_SSA_COARSE_SCORE=";
const SSA_RING_PREFIX: &str = "ARBI_SSA_RING_SCORE=";
const TOOM85_FLAG: &str = "--score-toom85";
const TOOM85_PREFIX: &str = "ARBI_TOOM85_SCORE=";
const TOOM85_MUL_FLAG: &str = "--score-toom85-mul";
const TOOM85_MUL_PREFIX: &str = "ARBI_TOOM85_MUL_SCORE=";
const BURNIKEL_FLAG: &str = "--score-burnikel";
const BURNIKEL_PREFIX: &str = "ARBI_BURNIKEL_SCORE=";
const NEWTON_FLAG: &str = "--score-newton";
const NEWTON_PREFIX: &str = "ARBI_NEWTON_SCORE=";
const PRODUCTION_DIVISION_FLAG: &str = "--score-production-division";
const PRODUCTION_DIVISION_PREFIX: &str = "ARBI_PRODUCTION_DIVISION_SCORE=";
const PRODUCTION_FLAG: &str = "--score-production";
const PRODUCTION_PREFIX: &str = "ARBI_PRODUCTION_SCORE=";
...
impl CandidateHarness {
    ...
    pub fn score_tier_pair(
        ...
        let values = self.score(profile, &flag, "ARBI_TIER_PAIR=")?;
    ...
    pub fn score_formatting_pair(
        ...
        let values = self.score(profile, &flag, "ARBI_FMT_PAIR=")?;
        let [baseline_time, candidate_time] = values.as_slice() else {
            return None;
        };
        Some((*baseline_time, *candidate_time))
...
fn write_candidate(profile: &TuningProfile, path: &Path) -> Option<()> {
    let source = profile.render("// Temporary profile generated by arbi-tune");
...
impl CandidateFile {
    fn new() -> Self {
        let path = env::temp_dir().join(format!("arbi-anafis-tuning-{}.rs", std::process::id()));
        Self { path }
    }
